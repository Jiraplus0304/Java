...
public class MainExam {
    ...
    private static final ToCompare[] cmps = { new ToCompare(999, "65130500011"),
    ...
    private static final ToBeLambda[] lds = {
        new ToBeLambda("Jirapluse", "Chanpong"),
    ...
    private static void exam02ToCompare() {
        ...
        Arrays.sort(cmps,ToCompare::compareByValue); // (array,comparator)
        System.out.println("  Sort by Value");
        for (ToCompare cmp : cmps) System.out.print(" : \n" + cmp);
        System.out.println();
    }
    ...
    private static void exam04Lambda() {
        ...
        Arrays.sort(lds, ToBeLambda.compareByFirstname); // use comparator to give it the natural sorting order
        ...
        for (ToBeLambda ld : lds) System.out.print(" : \n" + ld);
        System.out.println();
    }
